    ...
    if ($('#skin-toolbox').length) {
          ...
          switch (i) {
            case 'headerSkin':
              ...
              if (e === "bgc-light") {
                ...
                if (e === '') Branding.addClass('bg-dark');
              }
            ...
            case 'footerSkin':
              ...
              $('#toolbox-footer-skin input[value="bg-light"]').prop('checked', false);
              $('#toolbox-footer-skin input[value="' + e + '"]').prop('checked', true);
              break;
            case 'sidebarSkin':
      ...
      $('#toolbox-header-skin input').on('click', function() {
        ...
        if ($("#user-status").length)
          //$('#user-status + .btn-group > .btn').removeClass(btnClasses).addClass(btnClass);
        if ($("#user-role").length) {
          //$('#user-role + .btn-group > .btn').removeClass(btnClasses).addClass(btnClass);
        }

      });

      // Footer Skin Switcher
      $('#toolbox-footer-skin input').on('click', function() {
        var Val = $(this).val();
