                      ...
                      <div class="panel-body pn">
                          <div class="section row">
                              <div class="col-md-12 ph10 mb5">
                                  <label for="name" class="field prepend-icon">
                                      <input type="text" name="name" id="name" class="gui-input" placeholder="Nombre de la sucursal" autofocus>
                          ...
                          <div class="section">
                            <label class="field prepend-icon">
                              <textarea class="gui-textarea" id="description" name="description"
                                        placeholder="Descripci&oacute;n del lugar"></textarea>
                          ...
                          <div class="section">
                              <label for="phone" class="field prepend-icon">
                                  <input type="text" name="phone" id="phone" class="gui-input" placeholder="Tel&eacute;fono">
                          ...
                          <div class="section">
                              <label for="phone2" class="field prepend-icon">
                                  <input type="text" name="phone2" id="phone2" class="gui-input" placeholder="Tel&eacute;fono de respaldo">
                          ...
                          <div class="section">
                            <label class="field prepend-icon">
                              <textarea class="gui-textarea" id="adress" name="adress"
                                        placeholder="Direcci&oacute;n"></textarea>
                          ...
                          <div class="section">
                              <label for="capacity" class="field prepend-icon">
                                  <input type="number" name="capacity" id="capacity" class="gui-input" placeholder="Capacidad m&aacute;xima">
                          ...
                          <div class="section">
                              <div class="pull-right">
                                  <button type="submit" class="btn btn-gradient btn-system" id="btnRegistrar">Registrar sucursal</button>
                              </div>
                          </div>
                          <!-- end section -->
                      </div>
...
$("#form-register").validate({
  ...
  rules:{
    ...
    phone:{required: true, minlength: 8, maxlength: 25},
    phone2:{required:false, minlength: 8, maxlength: 25},
    adress:{required: true},
    capacity:{required:true, min:1}
  },
  messages:{
    name:{required: "Campo requerido", maxlength: "Máximo 25 caracteres"},
    phone:{required: "Campo requerido", minlength: "Mínimo 8 números", maxlength: "Máximo 20 números"},
    phone2:{maxlength: "Máximo 20 números"},
    adress:{required: "Campo requerido"},
    capacity:{required: "Campo requerido", min: "Valor mínimo 1"}
  },
