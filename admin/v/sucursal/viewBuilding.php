                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered table-responsive mbn">
                      ...
                      <tr class="warning">
                          ...
                          <th class="tcenter">Direcci&oacute;n</th>
                          <th class="tcenter">Tel&eacute;fono</th>
...
<script>
  ...
  function getRegistros(){
    $.ajax({
      async: true,
      method: "post",
      url: '../../c/getSucursales.php',
      success: function(resp){
        var datos = resp.split("@");
        var idSucursales = datos[0].split("¬");
        var nombre = datos[1].split("¬");
        var direccion = datos[2].split("¬");
        var telefono = datos[3].split("¬");
        var str = "";

          for(i=0; i<idSucursales.length; i++){
            str += '<tr><td class="tcenter"><strong>'+nombre[i]+'</strong></td><td class="tjustify">'+direccion[i]+'</td><td class="tcenter">'+telefono[i]+'</td><td class="tcenter"><a href="../../c/verSucursal.php?id='+idSucursales[i]+'" type="button" class="btn btn-system"><i class="fa fa-info"></i></a></td><td class="tcenter"><a href="../../c/editarSucursal.php?id='+idSucursales[i]+'" type="button" class="btn btn-info"><i class="fa fa-pencil"></i></a></td><td class="tcenter"><button type="button" onclick="modalEliminar('+idSucursales[i]+');" class="btn btn-danger"><i class="fa fa-trash"></i></button></td></tr>';
        }

        document.getElementById('datosSucursales').innerHTML = str; 
      }
    });
  }
