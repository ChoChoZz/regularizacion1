                      ...
                      <div class="panel-body pn">
                          <div class="section">
                              <label for="nameCourse" class="field prepend-icon">
                                  <input type="text" name="nameCourse" id="nameCourse" class="gui-input" placeholder="Nombre del curso" value="<?php echo $nombre; ?>">
                          ...
                          <div class="section">
                            <label class="field prepend-icon">
                              <textarea class="gui-textarea" id="description" name="description"
                                        placeholder="Descripci&oacute;n"><?php echo $descripcion; ?></textarea>
                          ...
                          <div class="section">
                            <label class="field prepend-icon append-button file">
                              ...
                              <input type="text" class="gui-input" id="uploader1" placeholder="Si deseas actualizar el temario elige un nuevo PDF, de lo contrario deja vacío este campo">
                          ...
                          <div class="section">
                              <label for="linkCourse" class="field prepend-icon">
                                  <input type="text" name="linkCourse" id="linkCourse" class="gui-input" placeholder="Link de la p&aacute;gina" value="<?php echo $url; ?>">
                          ...
                          <div class="section">
                            <label class="field prepend-icon append-button file">
                              ...
                              <input type="text" class="gui-input" id="uploader2" placeholder="Si deseas actualizar la imagen elige una nueva, de lo contrario deja vacío este campo. Recuerda que debe tener una resoluci&oacute;n de 400px x 300px">
                              <label class="field-icon">
                                <i class="fa fa-cloud-upload"></i>
                              </label>
                            </label>
                          ...
                          <div class="section">
                              <div class="pull-right">
                                  <button class="btn btn-gradient btn-system" type="submit" id="editarBtn">Actualizar curso</button>
                              </div>
                          </div>
                          <!-- end section -->
