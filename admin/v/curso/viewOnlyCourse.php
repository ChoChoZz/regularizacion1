...
$descripcion = $_SESSION['descripcionCurso'];
$temario = $_SESSION['temarioCurso'];
$url = $_SESSION['urlCurso'];
$imagen = $_SESSION['imagenCurso'];
?>
<!DOCTYPE html>
<html>
            ...
            <div class="admin-form theme-primary tab-pane mw600 active" id="register" role="tabpanel">
              <div class="panel">
                  ...
                  <div class="section row mb10">
                    <label for="store-name" class="field-label col-sm-2 ph10  text-center"><strong>Nombre: </strong></label>

                    <div class="col-sm-10 ph10">
                        <label for="store-name" class="field-label col-sm-10 ph10 tleft"><?php echo $nombre; ?></label>
                    </div>
                  </div>
                  ...
                  <div class="section row mb10">
                    <label for="store-name" class="field-label col-sm-2 ph10  text-center"><strong>Temario: </strong></label>

                    <div class="col-sm-10 ph10">
                        <?php if($temario != ''){ ?>
                        <label for="store-name" class="field-label col-sm-10 ph10 tleft"><a href="../../assets/temarios/<?php echo $temario; ?>" download> Temario</a> </label>
                        <?php } else{?>
                        <label for="store-name" class="field-label col-sm-10 ph10 tleft"><a href="#">Sin temario</a> </label>
                        <?php } ?>
                    </div>
                  </div>

                  <div class="section row mb10">
                    <label for="store-name" class="field-label col-sm-2 ph10  text-center"><strong>URL de la p&aacute;gina: </strong></label>

                    <div class="col-sm-10 ph10">
                        <label for="store-name" class="field-label col-sm-10 ph10 tleft"><a href="http://regularizacionipn.com/<?php echo $url; ?>"> http://regularizacionipn.com/<?php echo $url; ?> </a> </label>
                    </div>
                  </div>

                  <div class="section row mb10">
                    <label for="store-name" class="field-label col-sm-2 ph10  text-center"><strong>Imagen: </strong></label>

                    <div class="col-sm-10 ph10">
                        <label for="store-name" class="field-label col-sm-10 ph10 tleft"> <img src="./../../assets/img/cursos/<?php echo $imagen; ?>" /></label>
                    </div>
                  </div>

                  <div class="section row mb10">
                      <div class="pull-left pt5">
                          <button  class="btn btn-bordered btn-danger pull-right" onclick="modalEliminar(<?php echo $id; ?>);">Eliminar</button>
                      </div>
                      <a href="../../c/editarCurso.php?id=<?php echo $id; ?>" class="btn btn-bordered btn-system pull-right">Editar</a>
                  </div>                  
              </div>
