...
<body class="external-page sb-l-c sb-r-c">
  ...
  <div id="main" class="animated fadeIn">
    ...
    <section id="content_wrapper">
      ...
      <section id="content" class="">
        ...
        <div class="admin-form theme-primary mw750" id="register">
          <div class="bg-primary mw750 text-center mb20 br3 pv15">
            <img src="../admin/assets/img/slide2.png" class="img-responsive" alt="" />
            ...
            <div class="panel panel-primary">
              ...
              <form method="POST" onsubmit="return checkSubmit();" action="/" id="formid">
      ...
      <!--Ventana modal error registro-->
      <div id="enviandoRegistro" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="enviandoRegistro">
        <div class="modal-dialog ">
          <div class="modal-content">
            <div class="modal-header ">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title error" id="exampleModalLabel">Enviando</h4>
            </div>
            <div class="modal-body">
              <p class="justify"><strong>El registro ya se esta procesa, espera unos momentos.</strong> <br><br>
              </p>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
